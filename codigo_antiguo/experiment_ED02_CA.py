...
from GSAT_ED02_CA import GSAT
from WalkSAT_C04 import WalkSAT
...
# results_df = leer_datos_archivo('1.txt')
...
plt.title(f"WalkSAT communities - max tries={max_tries}, max flips=n/5")
